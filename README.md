...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-gtools-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-gtools-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-gtools-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-gtools-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-gtools-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-gtools-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-gtools/badges/version.svg)](https://anaconda.org/conda-forge/r-gtools)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-gtools/badges/downloads.svg)](https://anaconda.org/conda-forge/r-gtools)
